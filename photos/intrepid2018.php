...
?>
	...
	<div id="fullwidth">
		<ul class="contenthead"><li><a href="/photos.php"><h3>Photos</h3></li></a><li><h3>Intrepid Trip</h3></li></ul>
		<div class="fullcontent">
			...
			<div id="Intrepid 1" class="expandedImg">
				...
				<a href="/images/photos/2018_2019/intrepid_2018/intrepid_2018_beacon_1.jpg" class="printbutton" target="_blank">
			...
			<div id="Intrepid 2" class="expandedImg">
				...
				<button class="leftphotobutton" onclick="plusDivs(-1)">&#10094;</button>
				<button class="rightphotobutton" onclick="plusDivs(1)">&#10095;</button>
				<a href="/images/photos/2018_2019/intrepid_2018/intrepid_2018_beacon_2.jpg" class="printbutton" target="_blank">
					<i class="fa fa-print fa-lg" aria-hidden="true"></i>
				</a>
			...
			<div id="Intrepid 3" class="expandedImg">
				...
				<button class="leftphotobutton" onclick="plusDivs(-1)">&#10094;</button>
				<button class="rightphotobutton" onclick="plusDivs(1)">&#10095;</button>
				<a href="/images/photos/2018_2019/intrepid_2018/intrepid_2018_beacon_3.jpg" class="printbutton" target="_blank">
					<i class="fa fa-print fa-lg" aria-hidden="true"></i>
				</a>
			...
			<div id="Intrepid 4" class="expandedImg">
				...
				<button class="leftphotobutton" onclick="plusDivs(-1)">&#10094;</button>
				<button class="rightphotobutton" onclick="plusDivs(1)">&#10095;</button>
				<a href="/images/photos/2018_2019/intrepid_2018/intrepid_2018_beacon_4.jpg" class="printbutton" target="_blank">
					<i class="fa fa-print fa-lg" aria-hidden="true"></i>
				</a>
			...
			<div id="Intrepid 5" class="expandedImg">
				...
				<button class="leftphotobutton" onclick="plusDivs(-1)">&#10094;</button>
				<button class="rightphotobutton" onclick="plusDivs(1)">&#10095;</button>
				<a href="/images/photos/2018_2019/intrepid_2018/intrepid_2018_beacon_5.jpg" class="printbutton" target="_blank">
					<i class="fa fa-print fa-lg" aria-hidden="true"></i>
				</a>
			...
			<div id="Intrepid 6" class="expandedImg">
				...
				<button class="leftphotobutton" onclick="plusDivs(-1)">&#10094;</button>
				<button class="rightphotobutton" onclick="plusDivs(1)">&#10095;</button>
				<a href="/images/photos/2018_2019/intrepid_2018/intrepid_2018_beacon_6.jpg" class="printbutton" target="_blank">
					<i class="fa fa-print fa-lg" aria-hidden="true"></i>
				</a>
