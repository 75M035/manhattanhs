<?php 
$page_title = "Beacon Christmas Feast";
$page_description = "Photos from Beacon Christmas Feast 2015-2016";
...
?>
	...
	<div id="fullwidth">
		<ul class="contenthead"><li><a href="/photos.php"><h3>Photos</h3></li></a><li><h3>Beacon Christmas Feast</h3></li></ul>
		<div class="fullcontent">
			...
			<div id="Christmas 1" class="expandedImg">
				...
				<a href="/images/photos/2015_2016/christmas/christmas2015_1.jpg" class="printbutton" target="_blank">
					<i class="fa fa-print fa-lg" aria-hidden="true"></i>
				</a>
				<div class="imgtext">Christmas 1</div>
			</div>
			...
			<div id="Christmas 2" class="expandedImg">
				...
				<button class="leftphotobutton" onclick="plusDivs(-1)">&#10094;</button>
				<button class="rightphotobutton" onclick="plusDivs(1)">&#10095;</button>
				<a href="/images/photos/2015_2016/christmas/christmas2015_2.jpg" class="printbutton" target="_blank">
					<i class="fa fa-print fa-lg" aria-hidden="true"></i>
				</a>
				<div class="imgtext">Christmas 2</div>
			</div>
			...
			<div id="Christmas 3" class="expandedImg">
				...
				<button class="leftphotobutton" onclick="plusDivs(-1)">&#10094;</button>
				<button class="rightphotobutton" onclick="plusDivs(1)">&#10095;</button>
				<a href="/images/photos/2015_2016/christmas/christmas2015_3.jpg" class="printbutton" target="_blank">
					<i class="fa fa-print fa-lg" aria-hidden="true"></i>
				</a>
				<div class="imgtext">Christmas 3</div>
			</div>
			...
			<div id="Christmas 4" class="expandedImg">
				...
				<button class="leftphotobutton" onclick="plusDivs(-1)">&#10094;</button>
				<button class="rightphotobutton" onclick="plusDivs(1)">&#10095;</button>
				<a href="/images/photos/2015_2016/christmas/christmas2015_4.jpg" class="printbutton" target="_blank">
					<i class="fa fa-print fa-lg" aria-hidden="true"></i>
				</a>
				<div class="imgtext">Christmas 4</div>
			</div>
			<div id="Christmas 5" class="expandedImg">
				...
				<button class="leftphotobutton" onclick="plusDivs(-1)">&#10094;</button>
				<button class="rightphotobutton" onclick="plusDivs(1)">&#10095;</button>
				<a href="/images/photos/2015_2016/christmas/christmas2015_5.jpg" class="printbutton" target="_blank">
					<i class="fa fa-print fa-lg" aria-hidden="true"></i>
				</a>
				<div class="imgtext">Christmas 5</div>
			</div>
			...
			<div id="Christmas 6" class="expandedImg">
				...
				<button class="leftphotobutton" onclick="plusDivs(-1)">&#10094;</button>
				<button class="rightphotobutton" onclick="plusDivs(1)">&#10095;</button>
				<a href="/images/photos/2015_2016/christmas/christmas2015_6.jpg" class="printbutton" target="_blank">
					<i class="fa fa-print fa-lg" aria-hidden="true"></i>
				</a>
				<div class="imgtext">Christmas 6</div>
			</div>
			...
			<div id="Christmas 7" class="expandedImg">
				...
				<button class="leftphotobutton" onclick="plusDivs(-1)">&#10094;</button>
				<button class="rightphotobutton" onclick="plusDivs(1)">&#10095;</button>
				<a href="/images/photos/2015_2016/christmas/christmas2015_7.jpg" class="printbutton" target="_blank">
					<i class="fa fa-print fa-lg" aria-hidden="true"></i>
				</a>
				<div class="imgtext">Christmas 7</div>
			</div>
			...
			<div id="Christmas 8" class="expandedImg">
				...
				<button class="leftphotobutton" onclick="plusDivs(-1)">&#10094;</button>
				<button class="rightphotobutton" onclick="plusDivs(1)">&#10095;</button>
				<a href="/images/photos/2015_2016/christmas/christmas2015_8.jpg" class="printbutton" target="_blank">
					<i class="fa fa-print fa-lg" aria-hidden="true"></i>
				</a>
				<div class="imgtext">Christmas 8</div>
			</div>
			<div id="Christmas 9" class="expandedImg">
				...
				<button class="leftphotobutton" onclick="plusDivs(-1)">&#10094;</button>
				<button class="rightphotobutton" onclick="plusDivs(1)">&#10095;</button>
				<a href="/images/photos/2015_2016/christmas/christmas2015_9.jpg" class="printbutton" target="_blank">
					<i class="fa fa-print fa-lg" aria-hidden="true"></i>
				</a>
				<div class="imgtext">Christmas 9</div>
			</div>
			...
			<div id="Christmas 10" class="expandedImg">
				...
				<button class="leftphotobutton" onclick="plusDivs(-1)">&#10094;</button>
				<button class="rightphotobutton" onclick="plusDivs(1)">&#10095;</button>
				<a href="/images/photos/2015_2016/christmas/christmas2015_10.jpg" class="printbutton" target="_blank">
					<i class="fa fa-print fa-lg" aria-hidden="true"></i>
				</a>
				<div class="imgtext">Christmas 10</div>
			</div>
			...
			<div id="Christmas 11" class="expandedImg">
				...
				<button class="leftphotobutton" onclick="plusDivs(-1)">&#10094;</button>
				<button class="rightphotobutton" onclick="plusDivs(1)">&#10095;</button>
				<a href="/images/photos/2015_2016/christmas/christmas2015_11.jpg" class="printbutton" target="_blank">
					<i class="fa fa-print fa-lg" aria-hidden="true"></i>
				</a>
				<div class="imgtext">Christmas 11</div>
			</div>
			...
			<div id="Christmas 12" class="expandedImg">
				...
				<button class="leftphotobutton" onclick="plusDivs(-1)">&#10094;</button>
				<button class="rightphotobutton" onclick="plusDivs(1)">&#10095;</button>
				<a href="/images/photos/2015_2016/christmas/christmas2015_12.jpg" class="printbutton" target="_blank">
					<i class="fa fa-print fa-lg" aria-hidden="true"></i>
				</a>
				<div class="imgtext">Christmas 12</div>
			</div>
			...
			<div id="Christmas 13" class="expandedImg">
				...
				<button class="leftphotobutton" onclick="plusDivs(-1)">&#10094;</button>
				<button class="rightphotobutton" onclick="plusDivs(1)">&#10095;</button>
				<a href="/images/photos/2015_2016/christmas/christmas2015_13.jpg" class="printbutton" target="_blank">
					<i class="fa fa-print fa-lg" aria-hidden="true"></i>
				</a>
				<div class="imgtext">Christmas 13</div>
			</div>
			<div id="Christmas 14" class="expandedImg">
				...
				<button class="leftphotobutton" onclick="plusDivs(-1)">&#10094;</button>
				<button class="rightphotobutton" onclick="plusDivs(1)">&#10095;</button>
				<a href="/images/photos/2015_2016/christmas/christmas2015_14.jpg" class="printbutton" target="_blank">
					<i class="fa fa-print fa-lg" aria-hidden="true"></i>
				</a>
				<div class="imgtext">Christmas 14</div>
			</div>
			...
			<div id="Christmas 15" class="expandedImg">
				...
				<button class="leftphotobutton" onclick="plusDivs(-1)">&#10094;</button>
				<button class="rightphotobutton" onclick="plusDivs(1)">&#10095;</button>
				<a href="/images/photos/2015_2016/christmas/christmas2015_15.jpg" class="printbutton" target="_blank">
					<i class="fa fa-print fa-lg" aria-hidden="true"></i>
				</a>
				<div class="imgtext">Christmas 15</div>
			</div>
