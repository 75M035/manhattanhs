...
?>
	...
	<main id="directory">
		<h3 class="contenthead">Spring 2019 Courses <span class="rightlink"><a href="pastcourses.php">Past Courses</a><button class="btn btn-warning excelexport btn-md" type="button"></button></span></h3>
