...
?>
	...
	<main id="directory">
		<h2 class="contenthead">Fall 2022 Courses <span class="rightlink"><a href="pastcourses.php">Past Courses</a><button class="btn btn-warning excelexport btn-md" type="button" title="Excel Export"></button></span></h2>
