<?php 
$page_title = "Manhattan High School";
$page_description = "Manhattan High School Home Page";
		...
		<section id="left">
			...
			<article class="contentleft">
				...
				<div class="maincontent">
					...
					<p> You can fill out this survey by accessing the <a href="https://www.schools.nyc.gov/learning/in-our-classrooms/return-to-school-2020" target="_blank">Return to School 2020</a> page on the DOE website.</p>
				</div>
			</article>
			<article class="contentleft">
				...
				<div class="maincontent">
					...
					<ul class="noBullets">
						...
						<li>Wednesday (6/17): Ice Bucket Challenge</li><br />
					 	<li>Thursday (6/18): Senior Pizza Day </li><br />
						<li>Friday (6/19): Quarantine Fashion Day - Zoom Chat Room (2-3PM)</li>
					</ul>
		...
		<section id="right">
			<aside class="contentright">
				...
				<div class="sidecontent">
					...
					<p><span class="all-label">All</span> If you are a student or parent in need of tech support, please call or text (646) 397-9254, or email <a href="mailto:JPlaner@schools.nyc.gov">Mr. Planer (jplaner@schools.nyc.gov)</a>.</p>
					<p><span class="all-label">All</span> Parents and guardians can sign up for a NYC Schools account to keep track of their child's grades, schedule, transportation and more. Please email <a href="mailto:JPlaner@schools.nyc.gov">Mr. Planer (jplaner@schools.nyc.gov)</a> for help setting up your account.</p>
				</div>
			</aside>
			<aside class="contentright">
...
<footer id="footer">
	...
	<div id="footercontent">
		...
		<div class="footerbar"></div>
		<div id="righterfoot"><h3><a href="/nyspi.php">NYSPI</a></h3><p class="phone">(646) 774-7833</p><p>Children's Day Unit<br />1051 Riverside Drive<br />Suite 2500<br />New York, NY<br />10032</p></div>
	</div>
	<div id="nycdoelogo">
