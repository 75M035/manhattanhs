		...
		<div id="left">
			...
			<section class="contentleft">
				...
				<div class="maincontent">
					...
					<a href="https://my.ny.gov" id="buttontch" target="_blank"><div class="buttontop"></div><div class="buttonbottom">TEACH</div></a>
			...
			<section class="contentleft">
				...
				<div class="maincontent">
					...
					<a href="https://wiki.nycenet.edu/download/attachments/30015633/Install_Stars2.0_Client_latest.htm?version=1&modificationDate=1579014320537&api=v2" id="buttonist" target="_blank"><div class="buttontop"></div><div class="buttonbottom">Install STARS</div></a>
		...
		<div id="right">
			...
			<section class="contentright">
				...
				<div class="sidecontent">
					...
					<a href="https://infohub.nyced.org/docs/default-source/doe-employees-only/2022-23-central-calendar.pdf" id="buttoncl" target="_blank"><span class="pdf-label">PDF</span><div class="buttontop"></div><div class="buttonbottom">Calendar</div><div id="calm"><?php echo date("M"); ?></div><div id="cald"><?php echo date("d"); ?></div></a>
					<a href="http://www.nysed.gov/common/nysed/files/programs/state-assessment/regents-exams-schedule-january-2023.pdf" id="buttonrg" target="_blank"><span class="pdf-label">PDF</span><div class="buttontop"></div><div class="buttonbottom">Regents</div></a>
