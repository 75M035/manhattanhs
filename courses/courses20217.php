<?php 
$page_title = "Summer 2022 Courses";
$page_description = "Manhattan High School Summer 2022 Courses";
...
?>
	...
	<main id="directory">
		<ul class="contenthead"><li><a href="/pastcourses.php"><h2>Past Courses</h2></li></a><li class="lastcontenthead"><h2>Summer 2022 Courses</h2></li><li class="rightcontenthead"><span class="rightlink"><button class="btn btn-warning excelexport btn-md" type="button" title="Excel Export"></button></span></li></ul>
		<table id="directorylist" class="directorylist" data-paging="true" data-filtering="true" data-filter-position="center" data-sorting="true" data-paging-limit="4" data-filter-placeholder="Search (options on the right)" data-exporting="true">
			...
			<tbody>
				...
				<tr>
					<td><a href="/syllabi/2021_7/US_History_1_2_Syllabus_Prisco.pdf" target="_blank">US History 1/2</a></td>
					<td>Social Studies</td>
					<td>Prisco</td>
					<td>214</td>
					<td>BC, DE, GH</td>
				...
				<tr>
					<td><a href="/syllabi/2021_7/US_History_2_2_Syllabus_Prisco.pdf" target="_blank">US History 2/2</a></td>
					<td>Social Studies</td>
					<td>Prisco</td>
					<td>214</td>
					<td>BC, DE, GH</td>
