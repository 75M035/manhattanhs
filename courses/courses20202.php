<?php 
$page_title = "Spring 2021 Courses";
$page_description = "Manhattan High School Spring 2021 Courses";
...
?>
	...
	<main id="directory">
		<ul class="contenthead"><li><a href="/pastcourses.php"><h2>Past Courses</h2></li></a><li class="lastcontenthead"><h2>Spring 2021 Courses</h2></li><li class="rightcontenthead"><span class="rightlink"><button class="btn btn-warning excelexport btn-md" type="button" title="Excel Export"></button></span></li></ul>
...
$('.excelexport').on('click', function (e) {
    ...
    hiddenElement.download = 'Courses_2020_2.csv';
    hiddenElement.click();
}); 
</script>
