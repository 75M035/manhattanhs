...
?>
	...
	<main id="directory">
		<ul class="contenthead"><li><a href="/pastcourses.php"><h3>Past Courses</h3></li></a><li><h3>Summer 2019 Courses</h3></li><span class="rightlink"><button class="btn btn-warning excelexport btn-md" type="button"></button></span></ul>
