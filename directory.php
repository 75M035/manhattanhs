...
<main id="directory">
	<h2 class="contenthead">2019-2020 Staff Directory<span class="rightlink"><button class="btn btn-warning excelexport btn-md" type="button" title="Excel Export"></button></span></h2>	
